...
class DashboardLoader {
    ...
    async loadUserData() {
        try {
            ...
            if (userDoc.exists()) {
                ...
                const { setDoc } = await import('https://www.gstatic.com/firebasejs/10.12.1/firebase-firestore.js');
    ...
    async loadApplicationStats() {
        try {
            const { collection, query, where, getDocs } = await import('https://www.gstatic.com/firebasejs/10.12.1/firebase-firestore.js');
    ...
    async loadSchoolRecommendations() {
        try {
            ...
            const { collection, query, where, getDocs, limit, orderBy } = await import('https://www.gstatic.com/firebasejs/10.12.1/firebase-firestore.js');
